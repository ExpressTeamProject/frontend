...
export function Layout({ children }: LayoutProps) {
  return (
    <div className="flex min-h-screen flex-col bg-gray-50 dark:bg-gray-950">
      <header className="sticky top-0 z-40 border-b bg-white/80 backdrop-blur-md dark:bg-gray-950/80 dark:border-gray-800">
      ...
      <footer className="border-t py-8 bg-white dark:bg-gray-950 dark:border-gray-800">
        <div className="container px-4 md:px-8 max-w-full mx-auto">
          ...
          <div className="mt-8 pt-6 border-t dark:border-gray-800 flex flex-col md:flex-row justify-between items-center w-full">
            <p className="text-sm text-gray-500 dark:text-gray-400">© 2023 전공문제 공유 플랫폼. 모든 권리 보유.</p>
